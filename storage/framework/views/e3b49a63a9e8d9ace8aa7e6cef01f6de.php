  ...
  <header class="border-b border-gray-100 bg-white px-6 py-4 flex items-center gap-4">
    ...
    <div class="ml-auto flex items-center gap-3">
      <?php if(auth()->guard()->check()): ?>
        ...
        <a href="<?php echo e(route('user.profile')); ?>" class="text-sm text-gray-600 hover:text-gray-900">Account</a>
      ...
      <?php else: ?>
        <a href="<?php echo e(route('login', ['redirect' => $redirectTarget])); ?>" class="text-sm text-gray-600 hover:text-gray-900">Masuk</a>
        <a href="<?php echo e(route('register', ['redirect' => $redirectTarget])); ?>" class="px-3 py-1.5 text-sm font-medium rounded-lg bg-gray-900 text-white hover:bg-gray-800">Daftar</a>
      <?php endif; ?>
    </div>
  </header>
          ...
          <?php else: ?>
            <div class="space-y-3">
              ...
              <div class="flex gap-3">
                <a href="<?php echo e(route('login', ['redirect' => $redirectTarget])); ?>" class="flex-1 text-center bg-gray-900 text-white py-2.5 rounded-xl font-semibold hover:bg-gray-800 transition-colors">Login</a>
                <a href="<?php echo e(route('register', ['redirect' => $redirectTarget])); ?>" class="flex-1 text-center border border-gray-300 text-gray-700 py-2.5 rounded-xl font-semibold hover:bg-gray-50 transition-colors">Register</a>
              </div>
            </div>
          <?php endif; ?>
        <?php endif; ?>
