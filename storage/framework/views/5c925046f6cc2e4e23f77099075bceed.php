        ...
        <main class="flex-1 overflow-y-auto p-8">
            ...
            <div class="grid grid-cols-3 gap-6 mb-8">
                ...
                <div class="bg-white rounded-xl border border-gray-200 p-6">
                    ...
                    <p class="text-4xl font-bold text-gray-900"><?php echo e($stats['next_scheduled']); ?></p>
            ...
            <div class="bg-white rounded-xl border border-gray-200 overflow-hidden mb-8">
                ...
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-6 py-4">
                                <p class="text-sm font-medium text-gray-900"><?php echo e($backup['date']); ?></p>
                                <p class="text-xs text-gray-400"><?php echo e($backup['time']); ?></p>
                            </td>
                            <td class="px-6 py-4 text-sm text-gray-700 font-mono"><?php echo e($backup['name']); ?></td>
                            <td class="px-6 py-4 text-sm text-gray-600"><?php echo e($backup['size']); ?></td>
                            <td class="px-6 py-4">
                                <?php if($backup['status'] === 'successful'): ?>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-2">
                                    <?php if($backup['status'] === 'successful'): ?>
                                    <form method="POST" action="<?php echo e(route('admin.backup.restore', $backup['file'])); ?>">
                                        <?php echo csrf_field(); ?>
                                    ...
                                    <?php endif; ?>
                                    <form method="POST" action="<?php echo e(route('admin.backup.destroy', $backup['file'])); ?>">
                ...
                <div class="px-6 py-4 border-t border-gray-200">
                    <p class="text-sm text-gray-500">Showing 1 to <?php echo e(count($backups)); ?> of 128 entries</p>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\uprak-ecommerce\resources\views/admin/backup/index.blade.php ENDPATH**/ ?>