...
<?php $__env->startSection('title','Checkout - UKK E-Commerce'); ?>
<?php $__env->startSection('content'); ?>
<div class="app-viewport">
  <div class="app-canvas !block">
  <header class="h-16 bg-[#fcfcfd] border-b border-[#e3e6eb] px-7 py-4">
    <a href="<?php echo e(route('cart')); ?>" class="flex items-center gap-2 text-[#4b5563] hover:text-gray-900 text-sm font-semibold">
          ...
          <div class="ui-card p-6">
            ...
            <div class="grid grid-cols-2 gap-4">
              <div class="col-span-2 md:col-span-1">
                ...
                <input type="text" name="shipping_name" value="<?php echo e(old('shipping_name', auth()->user()->name)); ?>" required class="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-gray-900">
              </div>
              <div class="col-span-2 md:col-span-1">
                <label class="block text-sm font-medium text-gray-700 mb-1">No. Telepon</label>
                <input type="text" name="shipping_phone" value="<?php echo e(old('shipping_phone', auth()->user()->phone)); ?>" required class="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-gray-900">
              </div>
              <div class="col-span-2">
                <label class="block text-sm font-medium text-gray-700 mb-1">Alamat Lengkap</label>
                <input type="text" name="shipping_address" value="<?php echo e(old('shipping_address', auth()->user()->address)); ?>" required class="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-gray-900">
              </div>
              <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Kota</label>
                <input type="text" name="shipping_city" value="<?php echo e(old('shipping_city')); ?>" required class="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-gray-900">
              </div>
              <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Kode Pos</label>
                <input type="text" name="shipping_postal" value="<?php echo e(old('shipping_postal')); ?>" required class="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-gray-900">
              </div>
            </div>
          </div>
        ...
        <div class="w-full flex-shrink-0">
          <div class="ui-card p-6 sticky top-4">
            ...
            <div class="flex items-center gap-3 py-2 border-b border-gray-100 last:border-0">
              ...
              <div class="flex-1 min-w-0"><p class="text-xs font-medium text-gray-900 truncate"><?php echo e($item->product->name); ?></p><p class="text-xs text-gray-400">x<?php echo e($item->qty); ?></p></div>
              <p class="text-xs font-semibold"><?php echo e(\App\Helpers\CurrencyHelper::rupiah($item->qty * $item->product->price)); ?></p>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <div class="space-y-2 text-sm mt-4">
              <div class="flex justify-between"><span class="text-gray-500">Subtotal</span><span><?php echo e(\App\Helpers\CurrencyHelper::rupiah($subtotal)); ?></span></div>
              <div class="flex justify-between"><span class="text-gray-500">Pajak (11%)</span><span><?php echo e(\App\Helpers\CurrencyHelper::rupiah($tax)); ?></span></div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\uprak-ecommerce\resources\views/user/checkout.blade.php ENDPATH**/ ?>