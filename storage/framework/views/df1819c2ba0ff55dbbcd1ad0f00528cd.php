...
<div class="app-viewport">
  ...
  <header class="h-16 bg-[#fcfcfd] border-b border-[#e3e6eb] px-7 flex items-center justify-between">
    ...
    <nav class="flex items-center gap-8 text-sm font-semibold text-[#111827]"><a href="<?php echo e(route('user.products')); ?>">Katalog</a><a href="<?php echo e(route('user.history')); ?>">Promo</a><a href="<?php echo e(route('user.products')); ?>">Bantuan</a></nav>
  </header>
