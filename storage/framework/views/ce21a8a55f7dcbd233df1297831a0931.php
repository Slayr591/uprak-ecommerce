            ...
            <main class="flex-1 overflow-y-auto px-5 py-5 bg-[#f7f8fa]">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">
                    <div class="ui-card p-5">
                        ...
                        <p class="mt-2 text-5xl font-extrabold text-[#111827]"><?php echo e(number_format($stats['total_users'])); ?></p>
                        <p class="mt-2 text-xs <?php echo e($stats['user_growth'] >= 0 ? 'text-[#10b981]' : 'text-[#ef4444]'); ?> font-bold"><?php echo e($stats['user_growth'] >= 0 ? '+' : ''); ?><?php echo e($stats['user_growth']); ?>% vs last month</p>
                    </div>
                    <div class="ui-card p-5">
                        <p class="text-[13px] text-[#6b7280]">Total Staff</p>
                        <p class="mt-2 text-5xl font-extrabold text-[#111827]"><?php echo e(number_format($stats['total_staff'])); ?></p>
                        <p class="mt-2 text-xs text-[#10b981] font-bold">+<?php echo e(number_format($stats['active_staff'])); ?> active now</p>
                    </div>
                    <div class="ui-card p-5">
                        <p class="text-[13px] text-[#6b7280]">Monthly Revenue</p>
                        <p class="mt-2 text-4xl font-extrabold text-[#111827]"><?php echo e(\App\Helpers\CurrencyHelper::rupiah($stats['revenue_month'])); ?></p>
                        <p class="mt-2 text-xs <?php echo e($stats['revenue_growth'] >= 0 ? 'text-[#10b981]' : 'text-[#ef4444]'); ?> font-bold"><?php echo e($stats['revenue_growth'] >= 0 ? '+' : ''); ?><?php echo e($stats['revenue_growth']); ?>% growth curve</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 xl:grid-cols-3 gap-4">
                    ...
                    <div class="ui-card p-5">
                        ...
                        <div class="space-y-3">
                            <?php $__empty_1 = true; $__currentLoopData = $recentActivity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="flex gap-3">
                                    <div class="w-8 h-8 rounded-full bg-[#eef1f5] grid place-items-center text-[10px] font-bold text-[#1f2937]"><?php echo e(strtoupper(substr($activity['user']->name, 0, 2))); ?></div>
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center justify-between gap-2">
                                            <p class="text-sm font-semibold text-[#111827] truncate"><?php echo e($activity['user']->name); ?></p>
                                            <span class="text-[10px] font-bold px-2 py-0.5 rounded <?php echo e($activity['type'] === 'admin' ? 'bg-black text-white' : ($activity['type'] === 'staff' ? 'bg-[#d1fae5] text-[#065f46]' : 'bg-[#eef2f7] text-[#475569]')); ?>"><?php echo e(strtoupper($activity['type'])); ?></span>
                                        </div>
                                        <p class="text-xs text-[#6b7280]"><?php echo e($activity['action']); ?></p>
                                        <p class="text-[11px] text-[#9aa1ad] mt-1"><?php echo e($activity['time']); ?></p>
                                    </div>
                                </div>
                        ...
                        <a href="<?php echo e(route('admin.reports')); ?>" class="mt-4 block w-full h-10 rounded-lg bg-[#eef1f5] text-[#111827] text-sm font-bold text-center leading-10">View All Activity</a>
                    </div>
                </div>
            </main>
        </div>
