<aside class="w-[250px] bg-[#02050b] border-r border-[#111827] flex flex-col flex-shrink-0">
    ...
    <nav class="flex-1 px-3 py-4 space-y-1.5 overflow-y-auto">
        <a href="{{ route('admin.dashboard') }}" class="admin-side-link {{ request()->routeIs('admin.dashboard') ? 'active' : '' }}">
        ...
        <a href="{{ route('admin.users.index') }}" class="admin-side-link {{ request()->routeIs('admin.users.*') ? 'active' : '' }}">
        ...
        <a href="{{ route('admin.staff.index') }}" class="admin-side-link {{ request()->routeIs('admin.staff.*') ? 'active' : '' }}">
        ...
        <a href="{{ route('admin.permissions') }}" class="admin-side-link {{ request()->routeIs('admin.permissions*') ? 'active' : '' }}">
        ...
        <a href="{{ route('admin.reports') }}" class="admin-side-link {{ request()->routeIs('admin.reports') ? 'active' : '' }}">
        ...
        <a href="{{ route('admin.products.index') }}" class="admin-side-link {{ request()->routeIs('admin.products.*') ? 'active' : '' }}">
        ...
        <a href="{{ route('admin.orders.index') }}" class="admin-side-link {{ request()->routeIs('admin.orders.*') ? 'active' : '' }}">
        ...
        <div class="pt-3">
            ...
            <a href="{{ route('admin.backup.index') }}" class="admin-side-link {{ request()->routeIs('admin.backup*') ? 'active' : '' }}">
    ...
    <div class="border-t border-[#101a2a] p-4">
        <div class="rounded-xl border border-[#142235] bg-[#050913] p-3.5">
            <div class="flex items-center gap-3 mb-3">
                <div class="w-9 h-9 rounded-full bg-[#2ad887] text-[#04140d] flex items-center justify-center font-extrabold text-xs">{{ strtoupper(substr(auth()->user()->name,0,1)) }}</div>
                <div class="min-w-0">
