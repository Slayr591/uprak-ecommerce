  ...
  <div class="flex-1 flex flex-col overflow-hidden">
    <header class="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
      ...
      <nav class="flex items-center gap-6 text-sm">
        ...
        <a href="{{ route('admin.users.index') }}" class="text-black font-medium border-b-2 border-black pb-1">Users</a>
      </nav>
    </header>
    <main class="flex-1 overflow-y-auto p-8">
      ...
      <div class="px-8 pt-8">
        <div class="flex items-center justify-between mb-6">
          ...
          <a href="{{ route('admin.users.create') }}" class="flex items-center gap-2 bg-black text-white px-4 py-2.5 rounded-lg text-sm font-medium hover:bg-gray-900">
            ...
            <tr class="hover:bg-gray-50">
              <td class="px-6 py-4">
                <div class="flex items-center gap-3">
                  <div class="w-10 h-10 bg-gray-900 rounded-full flex items-center justify-center text-white text-sm font-bold">{{ substr($user->name,0,2) }}</div>
                  <div>
              ...
              <td class="px-6 py-4">
                <span class="text-xs px-2.5 py-1 rounded-full bg-gray-100 text-gray-700">{{ ucfirst($user->role) }}</span>
              </td>
              <td class="px-6 py-4">
                @if($user->is_active)
              ...
              <td class="px-6 py-4 flex items-center gap-2">
                <a href="{{ route('admin.users.edit',$user) }}" class="w-7 h-7 rounded border border-gray-200 flex items-center justify-center hover:bg-gray-50">
